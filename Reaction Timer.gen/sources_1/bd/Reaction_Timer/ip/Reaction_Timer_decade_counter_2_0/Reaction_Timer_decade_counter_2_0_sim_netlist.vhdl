...
-- Command     : write_vhdl -force -mode funcsim -rename_top Reaction_Timer_decade_counter_2_0 -prefix
--               Reaction_Timer_decade_counter_2_0_ Reaction_Timer_decade_counter_0_0_sim_netlist.vhdl
...
entity Reaction_Timer_decade_counter_2_0_decade_counter is
  port (
...
end Reaction_Timer_decade_counter_2_0_decade_counter;

architecture STRUCTURE of Reaction_Timer_decade_counter_2_0_decade_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Reaction_Timer_decade_counter_2_0 is
  port (
    EN : in STD_LOGIC;
    RESET : in STD_LOGIC;
    INCREMENT : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Reaction_Timer_decade_counter_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Reaction_Timer_decade_counter_2_0 : entity is "Reaction_Timer_decade_counter_0_0,decade_counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Reaction_Timer_decade_counter_2_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Reaction_Timer_decade_counter_2_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Reaction_Timer_decade_counter_2_0 : entity is "decade_counter,Vivado 2022.2";
end Reaction_Timer_decade_counter_2_0;

architecture STRUCTURE of Reaction_Timer_decade_counter_2_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of RESET : signal is "xilinx.com:signal:reset:1.0 RESET RST";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of RESET : signal is "XIL_INTERFACENAME RESET, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
U0: entity work.Reaction_Timer_decade_counter_2_0_decade_counter
     port map (
      EN => EN,
      INCREMENT => INCREMENT,
