...
--               Timer.gen/sources_1/bd/Reaction_Timer/ip/Reaction_Timer_DisplaySelector_0_0/Reaction_Timer_DisplaySelector_0_0_sim_netlist.vhdl}
...
entity Reaction_Timer_DisplaySelector_0_0_DisplaySelector is
  port (
  ...
  attribute ORIG_REF_NAME of Reaction_Timer_DisplaySelector_0_0_DisplaySelector : entity is "DisplaySelector";
end Reaction_Timer_DisplaySelector_0_0_DisplaySelector;

architecture STRUCTURE of Reaction_Timer_DisplaySelector_0_0_DisplaySelector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Reaction_Timer_DisplaySelector_0_0 is
  port (
    DISPLAY_CLK : in STD_LOGIC;
    CURRENT_DISPLAY : out STD_LOGIC_VECTOR ( 2 downto 0 )
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of Reaction_Timer_DisplaySelector_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Reaction_Timer_DisplaySelector_0_0 : entity is "Reaction_Timer_DisplaySelector_0_0,DisplaySelector,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Reaction_Timer_DisplaySelector_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Reaction_Timer_DisplaySelector_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Reaction_Timer_DisplaySelector_0_0 : entity is "DisplaySelector,Vivado 2022.2";
end Reaction_Timer_DisplaySelector_0_0;

architecture STRUCTURE of Reaction_Timer_DisplaySelector_0_0 is
...
begin
U0: entity work.Reaction_Timer_DisplaySelector_0_0_DisplaySelector
     port map (
